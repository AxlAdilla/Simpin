...
class BuatSimpananController extends Controller
{
    public function index()
    {
        ...
        return view('Manajer.BuatSimpanan.dashboard',compact(['data']));
    }
    ...
    public function index_print()
    {
        $indexService = new IndexService();
        $data = $indexService->execute(); 
        $pdf = PDF::loadview('Manajer.BuatSimpanan.laporan',compact(['data']))->setPaper('a4', 'landscape');
    ...
    public function create()
    {
        ...
        return view('Manajer.BuatSimpanan.create',compact(['data']));
    }
    ...
    public function edit($id)
    {
        ...
        return view('Manajer.BuatSimpanan.update',compact(['data']));
    }
