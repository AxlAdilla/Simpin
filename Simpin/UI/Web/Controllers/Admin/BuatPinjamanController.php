...
class BuatPinjamanController extends Controller
{
    public function index()
    {
        ...
        return view('Admin.BuatPinjaman.dashboard',compact(['data']));
    }
    ...
    public function index_print()
    {
        $indexService = new IndexService();
        $data = $indexService->execute(); 
        $pdf = PDF::loadview('Admin.BuatPinjaman.laporan',compact(['data']))->setPaper('a4', 'landscape');
    ...
    public function bayar($id)
    {
        ...
        return view('Admin.BuatPinjaman.bayar',compact(['data']));
    }
    ...
    public function create()
    {
        ...
        return view('Admin.BuatPinjaman.create',compact(['data']));
    }
    ...
    public function show($id)
    {
        ...
        return view('Admin.BuatPinjaman.show',compact(['data']));
    ...
    public function edit($id)
    {
        ...
        return view('Admin.BuatPinjaman.update',compact(['data']));
    }
