...
class PendaftaranController extends Controller
{
    public function index()
    {
        ...
        return view('Admin.Pendaftaran.dashboard',['data'=>$indexService->execute()]);
    ...
    public function index_range($range)
    {
        ...
        return view('Admin.Pendaftaran.dashboard',['data'=>$indexRangeService->execute()]);
    ...
    public function index_print()
    {
        ...
        $pdf = PDF::loadview('Admin.Pendaftaran.laporan',compact(['data']))->setPaper('a4', 'landscape');
    ...
    public function create()
    {
        ...
        return view('Admin.Pendaftaran.create',compact(['data']));
    }
    ...
    public function edit($id)
    {
        ...
        return view('Admin.Pendaftaran.update',compact(['data']));
    }
