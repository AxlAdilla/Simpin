    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{route('dashboard')}}" style="font-weight:800" >KOPERASI SERBA USAHA | KSU</a>
            </div>
        </div>
    </nav>
    <!-- #Top Bar -->
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li @yield('active_anggota')>
                        <a href="{{route('pendaftaran_index')}}">
                            <i class="material-icons">face</i>
                            <span>Anggota</span>
                        </a>
                    </li>
                    <li @yield('active_simpanan')>
                        <a href="{{route('simpanan_index')}}">
                            <i class="material-icons">account_balance_wallet</i>
                            <span>Simpanan</span>
                        </a>
                    </li>
                    <li @yield('active_pinjaman')>
                        <a href="{{route('pinjaman_index')}}">
                            <i class="material-icons">credit_card</i>
                            <span>Pinjaman</span>
                        </a>
                    </li>
                    <li @yield('active_akun')>
