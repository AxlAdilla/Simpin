        ...
        <div class="row clearfix">
            <div class="col-xs-12" style="margin-bottom:30px">
                <div style="display:flex;justify-content:flex-end">
                    ...
                    <button class="btn btn-danger waves-effect m-r-10 m-l-10" onClick="filter('{{route('manajer.pendaftaran_show_range',['range'=>'/','id'=>$data['anggota']->id])}}')" style="font-weight:800">FILTER</button>
                </div>
            </div>
