        ...
        <div class="row clearfix">
            <div class="col-xs-12" style="margin-bottom:30px">
                <div style="display:flex;justify-content:flex-end">
                    ...
                    <button class="btn btn-danger waves-effect m-r-10 m-l-10" onClick="filter('{{route('dashboard_range',['range'=>'/'])}}')" style="font-weight:800">FILTER</button>
                </div>
            </div>
                                ...
                                <table id="" class="display responsive" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div>
                                                    <a style="text-decoration:none;font-weight:700;color:black" href="{{route('pendaftaran_show',['id'=>$anggota->id])}}">{{$anggota->nama_anggota}}</a> asal {{$anggota->alamat}} didaftarkan menjadi anggota 
                                                </div>
                                            <!-- </td>
                                            <td> -->
