        ...
        <div class="row clearfix">
            <div class="col-xs-12" style="margin-bottom:30px">
                <div style="display:flex;justify-content:flex-end">
                    ...
                    <button class="btn btn-danger waves-effect m-r-10 m-l-10" onClick="filter('{{route('simpanan_index_range',['range'=>'/'])}}')" style="font-weight:800">FILTER</button>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="header">
                        <div style="display:flex;justify-content:flex-end">
                            ...
                            <a class="btn btn-success m-l-5 m-r-5" style="font-weight:700" href="{{route('simpanan_create')}}"><i class="material-icons">
                            add
                            </i> SIMPANAN</a>
                        </div>
                    </div>
                                    ...
                                    <td>       
                                        <div style="display:flex;justify-content:flex-end">
                                            <div class="m-l-5 m-r-5">
                                                <a class="btn btn-warning" href="{{route('simpanan_edit',['id'=>$simpanan->id])}}">
                                            ...
                                            <form  class="m-l-5 m-r-5" style="display:inline-block" method="post" onsubmit="delete_row(event)" action="{{route('simpanan_destroy',['id'=>$simpanan->id])}}">
...
function delete_row(e) {
    ...
    Swal.fire({
        title: 'Anda Yakin Menghapus Simpanan?',
        icon: 'warning',
